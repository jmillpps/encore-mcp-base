...
Production deployment runs the Encore service with explicit public URLs, registered OAuth clients, durable storage, allowed origins, signing keys, token lifetimes, and rate limits.
