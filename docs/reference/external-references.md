...
| [MCP Pagination, 2025-11-25](https://modelcontextprotocol.io/specification/2025-11-25/server/utilities/pagination) | Opaque cursor paging, `nextCursor`, invalid cursor handling, and paginated list operations. | [MCP API Reference](../api/mcp.md), [MCP Transports](../architecture/mcp-transports.md) |
