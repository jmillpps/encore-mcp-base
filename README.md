...
For the full documentation map, start at [docs/index.md](docs/index.md). Use [Local Development](docs/user-guides/local-development.md) to run the service, [GPT Apps Setup](docs/user-guides/gpt-apps.md) to connect MCP, and [GPT Actions Setup](docs/user-guides/gpt-actions.md) to export and install the Actions schema. The architecture overview lives in [docs/architecture/overview.md](docs/architecture/overview.md). Production setup lives in [docs/deployment/production.md](docs/deployment/production.md).
...
GPT Actions use `/actions/profile`, `/actions/session`, and `/health`. Actions details are in [docs/api/actions.md](docs/api/actions.md).
